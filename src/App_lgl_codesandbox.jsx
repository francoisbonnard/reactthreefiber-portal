// https://codesandbox.io/s/lgl-raytracer-forked-8yfnd
...
export default function App_lgl_codesandbox() {
...
function Rover(props) {
  const { scene } = useGLTF(
    "https://raw.githubusercontent.com/gkjohnson/gltf-demo-models/main/nasa-m2020/Perseverance.glb"
  )
  return (
    <primitive
      object={scene}
